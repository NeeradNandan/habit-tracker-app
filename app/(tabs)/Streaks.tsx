                        ...
                        </Text>
                        {
                            rankedHabits.slice( 0, 3 ).map(( item,key ) => (
                                ...
                                >
                                    ...
                                    <Text
                                        style={styles.rankingHabitTitle}
                                    >
                                        {
                                            item.habit.title
                                        }
                                    ...
                                    <Text
                                        style={styles.rankingHabitStreak}
                                    >
                                        {
                                            item.bestStreak
                                        }
                                             ...
                                             <Card.Content>
                                                 ...
                                                 >
                                                     ...
                                                     >
                                                         ...
                                                         <Text
                                                             style={styles.statBadgeLabel}
                                                         >
                                                             Current
                                                         </Text>
                                                     </View>
                                                     <View
                                                         style={styles.statGoldBadge}
                                                     >
                                                         <Text
                                                             style={styles.statBadgeText}
                                                         >
